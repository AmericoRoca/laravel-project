...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header" style="background-color:#1A1A1A; color:#F58026;">{{ __('Configuration Account') }}</div>
...
<!-- 
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="image_path" class="col-md-4 col-form-label text-md-end" style="color:#F58026">{{ __('Avatar') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="image_path" type="file" class="form-control @error('image_path') is-invalid @enderror" name="image_path" value=""  autocomplete="image_path" style="background-color:#1A1A1A;color:#F58026">
