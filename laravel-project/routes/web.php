...
//LikeController
Route::get('/like/{image_id}', [App\Http\Controllers\LikesController::class, 'like'])->name('like.save');
Route::get('/dislike/{image_id}', [App\Http\Controllers\LikesController::class, 'dislike'])->name('like.delete');
